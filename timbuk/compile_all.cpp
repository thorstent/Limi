...
void all() {
  ...
  Limi::deadlock_algo<timbuk::state,timbuk::symbol,timbuk::automaton> da;
  ...
  Limi::antichain_algo_ind<timbuk::state,timbuk::state,timbuk::symbol, automaton, automaton> aai(aut,aut,2,ind);
  Limi::antichain_algo<timbuk::state,timbuk::state,timbuk::symbol, automaton, automaton> aa(aut,aut);
